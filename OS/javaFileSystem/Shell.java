			...
			if (asCommandArray.length == 0) {
				...
				case 3: // create
					if (asCommandArray.length != 2) {
						...
						System.out.println(m_Filesystem.create(split(
				...
				case 8: // copy
					if (asCommandArray.length != 3) {
						...
						System.out.println(m_Filesystem.copy(split(
								asCommandArray[1], '/'), split(
								asCommandArray[2], '/')));
					}
					break;
				...
				case 9: // append
					if (asCommandArray.length != 3) {
						...
						System.out.println(m_Filesystem.append(split(
								asCommandArray[1], '/'), split(
								asCommandArray[2], '/')));
					}
					break;
				...
				case 10: // rename
					if (asCommandArray.length != 3) {
						...
						System.out.println(m_Filesystem.rename(split(
								asCommandArray[1], '/'), split(
								asCommandArray[2], '/')));
					}
					break;
